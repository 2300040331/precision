...
async function seed() {
  ...
  // Home Page Sections
  const existingSections = await prisma.section.findMany({ where: { pageId: 'home' } });
      ...
      data: [
        {
          ...
          content: JSON.stringify({
            ...
            description: 'We deliver comprehensive financial, tax, and strategic advisory services that drive business growth, ensure statutory compliance, and maximize shareholder value.',
            ctaPrimaryText: 'Schedule Consultation',
            ctaPrimaryLink: '#consultation',
            ctaSecondaryText: 'Explore Our Services',
            ctaSecondaryLink: 'services.html',
            bgBadge: 'Trusted by 500+ Enterprises Across India',
          }),
        },
        {
          pageId: 'home',
          type: 'stats',
          name: 'Key Metrics & Counters',
          order: 2,
          visible: true,
          content: JSON.stringify({
            stat1Value: '15+',
            ...
            stat3Value: '₹5,000 Cr+',
            stat3Label: 'Transactions Audited',
            stat4Value: '99.8%',
        ...
        },
        {
          ...
          name: 'Services Grid Overview',
          order: 4,
          visible: true,
          content: JSON.stringify({
            title: 'Core Practice Areas & Advisory Services',
            subtitle: 'OUR SERVICES',
            description: 'End-to-end audit, advisory, and compliance solutions engineered for regulatory compliance and business scalability.',
          }),
        },
        {
          pageId: 'home',
          ...
          visible: true,
          content: JSON.stringify({
            title: 'Ready to elevate your financial strategy and compliance?',
            subtitle: 'Connect with our senior partners today for a confidential consultation.',
